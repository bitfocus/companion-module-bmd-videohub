 ...
 * @since 1.1.0
 */
export function updateDevice(labeltype, object) {
 ...
 * @since 1.0.0
 */
export function updateLabels(labeltype, object) {
	for (var key in object) {
		var parsethis = object[key]
		var a = parsethis.split(/ /)
 ...
 * @since 1.1.0
 */
export function updateLocks(labeltype, object) {
	for (var key in object) {
		var parsethis = object[key]
		var a = parsethis.split(/ /)
		var num = parseInt(a.shift())
 ...
 * @since 1.0.0
 */
export function updateRouting(labeltype, object) {
	for (var key in object) {
		var parsethis = object[key]
		var a = parsethis.split(/ /)
 ...
 * @since 1.1.0
 */
export function updateSerialDirections(labeltype, object) {
	for (var key in object) {
		var parsethis = object[key]
		var a = parsethis.split(/ /)
		var num = parseInt(a.shift())
 ...
 * @since 1.1.0
 */
export function updateStatus(labeltype, object) {
	for (var key in object) {
		var parsethis = object[key]
		var a = parsethis.split(/ /)
		var num = parseInt(a.shift())
